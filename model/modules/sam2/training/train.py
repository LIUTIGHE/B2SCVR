...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--config",
        type=str,
        default="configs/sam2.1_training/sam2.1_hiera_t_BSCV_lac_atd.yaml",
        required=True,
...
# python training/train.py -c configs/sam2.1_training/sam2.1_hiera_t_BSCV_finetune.yaml --use-cluster 0 --num-gpus 4
# python training/train.py -c configs/sam2.1_training/sam2.1_hiera_t_BSCV_lac_dino_atd.yaml --use-cluster 0 --num-gpus 1
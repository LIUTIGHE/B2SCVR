...
def vos_separate_inference_per_object(
    ...
    frame_names.sort(key=lambda p: int(os.path.splitext(p)[0]))
    mv_dir = os.path.join(input_mv_dir, video_name+'_2.h264')
    pm_dir = os.path.join(input_pm_dir, video_name+'_2.h264.txt')
    inference_state = predictor.init_state(
        video_path=video_dir, mv_path=mv_dir, pm_path=pm_dir, async_loading_frames=False
    )
    height = inference_state["video_height"]
    width = inference_state["video_width"]
    input_palette = None
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="directory containing input mv maps (as PNG files) of each video",
    )
    parser.add_argument(
        "--input_pm_dir",
        type=str,
        required=True,
        help="directory containing input pm seq (as TXT files) of each video",
    )
    parser.add_argument(
        "--video_list_file",
        type=str,
    ...
    for n_video, video_name in enumerate(video_names):
        if n_video + 1 < 633 or n_video + 1 == 641:
            print(f"skipping video {n_video + 1} ({video_name})")
            continue
        ...
        if not args.track_object_appearing_later_in_video:
            ...
            vos_separate_inference_per_object(
                predictor=predictor,
                base_video_dir=args.base_video_dir,
                input_mv_dir = args.input_mv_dir,
                input_pm_dir = args.input_pm_dir,
                input_mask_dir=args.input_mask_dir,
                output_mask_dir=args.output_mask_dir,
                video_name=video_name,
                score_thresh=args.score_thresh,
...
atd_simple_bs:
python ./tools/vos_inference.py --sam2_cfg configs/sam2.1/sam2.1_hiera_t.yaml \
    --sam2_checkpoint /root/sam2/sam2_logs/configs/sam2.1_training/sam2.1_hiera_t_BSCV_lac_atd_simple_50eps.yaml/checkpoints/checkpoint.pt \
    --base_video_dir /root/autodl-tmp/datasets/BSCV/test/bsc_imgs \
    --input_mask_dir /root/autodl-tmp/datasets/BSCV/test/masks \
    --video_list_file /root/autodl-tmp/datasets/BSCV/test/test_list.txt \
    --output_mask_dir ./outputs/lacatd_simple50_BSCV_pred_pngs \
    --track_object_appearing_later_in_video
    
python ./tools/vos_inference.py --sam2_cfg configs/sam2.1/sam2.1_hiera_t.yaml \
    --sam2_checkpoint /media/tianyi/BSC-VideoCompletion/baselines/BSCV/model/modules/sam2/sam2_logs/configs/sam2.1_training/sam2.1_hiera_t_BSCV_lac_atd_dino_50eps.yaml/checkpoints/checkpoint.pt \
    --base_video_dir /media/tianyi/BSC-VideoCompletion/test_184096/test_184096/BSC_JPEGImages \
    --input_mask_dir /media/tianyi/BSC-VideoCompletion/test_184096/test_184096/Annotations \
    --input_mv_dir /media/tianyi/BSC-VideoCompletion/test_184096/test_184096/bsc_mv/mv_maps \
    --input_pm_dir /media/tianyi/BSC-VideoCompletion/test_184096/test_184096/bsc_mv/frame_types \
    --video_list_file /media/tianyi/BSC-VideoCompletion/test/test_list.txt \
    --output_mask_dir /media/tianyi/BSC-VideoCompletion/test_184096/test_184096/lacatd_dino50_BSCV184096_pred_pngs \
    --track_object_appearing_later_in_video

finetuned SAM cmd: # in original sam2 folder, not here
python ./tools/vos_inference.py --sam2_cfg configs/sam2.1/sam2.1_hiera_t.yaml \
    --sam2_checkpoint /media/tianyi/BSC-VideoCompletion/baselines/BSCV/model/modules/sam2/sam2_logs/configs/sam2.1_training/sam2.1_hiera_t_BSCV_finetune_fr5_lrx1_40eps.yaml/checkpoints/checkpoint.pt \
    --base_video_dir /media/tianyi/BSC-VideoCompletion/test_184096/test_184096/BSC_JPEGImages \
    --input_mask_dir /media/tianyi/BSC-VideoCompletion/test_184096/test_184096/Annotations \
    --video_list_file /media/tianyi/BSC-VideoCompletion/test/test_list.txt \
    --output_mask_dir /media/tianyi/BSC-VideoCompletion/test_184096/test_184096/sam2_BSCV184096_pred_pngs \
    --track_object_appearing_later_in_video


python ./tools/vos_inference.py --sam2_cfg configs/sam2.1/sam2.1_hiera_t.yaml \
    --sam2_checkpoint /media/tianyi/BSC-VideoCompletion/baselines/BSCV/model/modules/sam2/sam2_logs/configs/sam2.1_training/sam2.1_hiera_t_BSCV_lac_atd_dino_50eps.yaml/checkpoints/checkpoint.pt \
    --base_video_dir /media/tianyi/BSC-VideoCompletion/test_444096/test_444096/BSC_JPEGImages \
    --input_mask_dir /media/tianyi/BSC-VideoCompletion/test_444096/test_444096/Annotations \
    --input_mv_dir /media/tianyi/BSC-VideoCompletion/test_444096/test_444096/bsc_mv/mv_maps \
    --input_pm_dir /media/tianyi/BSC-VideoCompletion/test_444096/test_444096/bsc_mv/frame_types \
    --video_list_file /media/tianyi/BSC-VideoCompletion/test_444096/test_444096/test_list_444096.txt \
    --output_mask_dir /media/tianyi/BSC-VideoCompletion/test_444096/test_444096/lacatd_dino50_BSCV444096_pred_pngs \
    --track_object_appearing_later_in_video
...
python ./tools/vos_inference.py --sam2_cfg configs/sam2.1/sam2.1_hiera_t.yaml \
    ...
    --input_mask_dir /media/tianyi/BSC-VideoCompletion/test_444096/test_444096/Annotations \
    --video_list_file /media/tianyi/BSC-VideoCompletion/test_444096/test_444096/test_list_444096.txt \
    --output_mask_dir /media/tianyi/BSC-VideoCompletion/test_444096/test_444096/sam2_BSCV444096_pred_pngs \
    --track_object_appearing_later_in_video
